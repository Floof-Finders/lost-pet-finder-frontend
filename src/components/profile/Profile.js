					...
					<Container>
						<Card style={{ width: '30rem' }}>
							<Card.Body>
								...
								<Button onClick={() => setShowUser(true)} variant="primary">Update Profile</Button>
							</Card.Body>
						</Card>
					</Container>
				</Col>
						...
						<Col key={id}>
							<Card style={{ width: '25rem' }}>
								...
								<Card.Body>
									...
									<Card.Text>
										Pet Bio: Lorem Ipsum is simply dummy text of the printing and typesetting industry.
									</Card.Text>
									...
									<Button onClick={() => setShowPet(true)} variant="primary">Update Pet</Button>
								</Card.Body>
							</Card>
						</Col>
					))}
